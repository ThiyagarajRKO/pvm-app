...
import { Plus, Download, Archive, Search, Filter, X } from 'lucide-react';
  ...
  return (
    <div className="pb-[calc(5rem+env(safe-area-inset-bottom))] sm:pb-0">
          ...
          <div className="mt-4 flex flex-col gap-2 rounded-lg border bg-muted/50 p-3 sm:hidden">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {streetFilter && (
                <Badge
                  variant="secondary"
                  className="bg-purple-100 text-xs text-purple-800 hover:bg-purple-200"
                >
                  Street: {streetFilter}
                  <Button
                    variant="ghost"
              ...
              {placeFilter && (
                <Badge
                  variant="secondary"
                  className="bg-orange-100 text-xs text-orange-800 hover:bg-orange-200"
                >
                  Place: {placeFilter}
                  <Button
                    variant="ghost"
      ...
      <MobileBottomSheet
        ...
        title="Filters"
        description="Filter archived records"
