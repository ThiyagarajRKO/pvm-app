...
function AdminLayoutComponent({ children }: AdminLayoutProps) {
  ...
  const Header = () => (
    <header className="fixed-header fixed left-0 right-0 top-0 z-40 flex h-16 items-center justify-between border-b-0 border-t-0 bg-background px-4 md:border-b lg:px-6">
      <div className="flex items-center">
